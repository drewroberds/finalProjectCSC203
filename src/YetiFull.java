...
public class YetiFull extends Yeti {
    ...
    public void transformYetiFull(WorldModel world, EventScheduler scheduler, ImageStore imageStore) {
        YetiDudeNotFull yeti = new YetiDudeNotFull(Yeti.YETI_DUDE_KEY, this.getPosition(), imageStore.getImageList(YetiDudeNotFull.YETI_DUDE_KEY), 3, 0, YETI_ACTION_PERIOD, YETI_ANIMATION_PERIOD, 0, this.getHealthLimit());
